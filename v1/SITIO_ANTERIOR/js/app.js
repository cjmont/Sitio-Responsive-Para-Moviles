                ...
                if (objeto.tipo === "Curso"){
                   ...
                   console.log("HOLA");
                    ...
                    try {
                        ...
                        document.getElementById('nombreCurso' + i).innerHTML = objeto.nombre.slice(0,50);
                        document.getElementById('descripcionCurso' + i).innerHTML = objeto.contenido.objetivo.slice(0,120);
                    }
                    catch(err) {
...
function cargarCorp () {
    ...
    fetch('http://200.10.147.137/api/corporativopost', {
      method: 'post',
      headers: {
        'Accept': 'application/json, text/plain, */*',
        'Content-Type': 'application/json'
